...
NOT_YET_CLASSIFIED = {
    ...
    'helix', 'hole', 'interface_align_check', 'interference_check', 'job_list',
    ...
    'ping', 'pocket', 'polar_pattern', 'press_fit_stress', 'publish_interface',
    'query_faces', 'register_handle', 'render_capabilities', 'render_job',
    ...
    'set_visibility', 'shell_solid', 'solve_capabilities', 'sweep', 'thickness',
