...
# The opt-in durable journal: on-disk record, retention, redaction, export (#433).
Test-Module 'Durable journal (#433)' 'test_journal_durable.py'
...
Test-Module 'CI parity diff reports untested coverage (#342)' 'test_ci_parity_diff.py'
...
Test-Module 'Molding solvers cross the relay (#386)'  'test_molding_relay.py'
Test-Module 'Tier A: impact'                         'test_impact.py'
Test-Module 'Impact dynamics deck/gate (#311)'       'test_impact_case.py'
...
Test-Module "doctor's Gatekeeper diagnosis (#310)"    'test_doctor_gatekeeper.py'
