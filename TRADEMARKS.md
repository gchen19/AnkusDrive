...
Apache-2.0 deliberately does not license trademarks (see Section 6 of the License). That's not
an oversight — it's how open-source projects stay open while keeping one thing reliable: when a
user sees the AnkusDrive name, they know where the software came from. This policy exists to
prevent user confusion, not to restrict legitimate use of the software.
...
- **Referring to the project.** Writing about, reviewing, teaching, criticizing, or linking to
...
- **Forking.** You may fork the code freely. Say your fork is "based on AnkusDrive" or "a fork
  of AnkusDrive" — just don't *name* your fork AnkusDrive (see below).
- **Community use.** User groups, meetups, and unofficial community resources, as long as it's
  clear you're not speaking for the project.
...
- **Modifying the logo** — recoloring, redrawing, changing proportions, adding elements, or
  incorporating it into another logo.
...
- Don't use the logo as your own avatar, app icon, or favicon for a non-official project.

## Third-party marks

AnkusDrive interoperates with **FreeCAD**, which is an independent project with its own name
and marks. AnkusDrive is not affiliated with, endorsed by, or sponsored by the FreeCAD project
or the FreeCAD Project Association. All other product names, logos, and brands referenced are
the property of their respective owners and are used only to describe interoperability.

## Requesting permission

For any use requiring permission, or if you're unsure, open an issue at
<https://github.com/gchen19/AnkusDrive/issues>. We aim to say yes to good-faith community
use.

## Changes

This policy may be updated as the project grows. The current version always lives in this file
in the project repository.

---

*This document is a project policy, not legal advice. If you need certainty about a specific
use, consult your own attorney.*
