...
to a first-class object:
  ...
  * a **master/skeleton** single-source-of-truth slot — the lean interface-
    ...
    master-model pattern mapped onto DriftPin's publish/subscribe);
...
Like driftpin/items.py and driftpin/manifest.py this is **pure Python** — no
...
--- The contract (project.json, schema "driftpin.project/1") -------------------

    {
      "schema": "driftpin.project/1",
...
# merge, the cheap way the rest of DriftPin catches a malformed contract at the door.
