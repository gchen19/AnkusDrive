...
The front has a 2-inch screen and a 19 mm steel button with a coloured ring. The screen always
shows three things: **what state the scanner is in**, **what to do**, and a footer with **what a
PRESS does and what a HOLD does right now**. The ring shows the state in colour so you can see it
...
percentage of the best value seen, and a second bar for the corners of the field. The ring's brightness
...
- **Not sure what a press will do.** Read the footer. It changes with the state, and the ring
...
- **Camera or counting failure.** Red ring, the message on screen, and the run's raw frames are
