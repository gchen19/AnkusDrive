...
# layer over this module — it lives in ankusdrive/relations.py (the parser /
...
def resolve_manifest(manifest):
    ...
    (ankusdrive.relations, #137 — arithmetic + table lookup, no solver), then the
    ...
    from ankusdrive.relations import resolve_relations  # local: keep import light
