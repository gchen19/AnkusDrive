...
THE KEYSTONE (RFC docs/DESIGN_HIERARCHY.md §1, §2.1). AnkusDrive deliberately does
...
``declare_intent``). It is AnkusDrive's intra-part parametric model AND its
...
schema declaration, input validation (typed via :mod:`ankusdrive.units`), and the
