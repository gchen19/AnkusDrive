...
the same permissive footing as AnkusDrive. It is a DEPENDENCY-CLASH boundary:
Bempp needs ``meshio>=4`` (``cells_dict``), but AnkusDrive's shared venv pins
``meshio==3.0`` for ``solidspy`` (``ankusdrive/analysis/topology.py``). Upgrading
