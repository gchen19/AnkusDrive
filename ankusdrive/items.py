...
In AnkusDrive today a part *is* its file path. There is no logical identity for
...
registry, exactly like ankusdrive/manifest.py's resolve step. The MCP handlers in
...
items.json (schema "ankusdrive.items/1"):

    {
      "schema": "ankusdrive.items/1",
