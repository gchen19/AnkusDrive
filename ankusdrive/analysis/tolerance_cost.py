...
:mod:`ankusdrive.analysis.tolerance` — there is one source of truth for the bands and
...
def _row(nominal_mm: float) -> tuple[list[int], list[float]]:
    ...
    Straight out of :mod:`ankusdrive.analysis.tolerance` — this module never
...
def tolerance_cost_check(chain: list, process: str = "cnc") -> dict:
    ...
    :mod:`ankusdrive.analysis.tolerance`'s convention — ``{name, nominal, plus,
