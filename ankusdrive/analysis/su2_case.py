...
caller hand-prepared, which no AnkusDrive tool could produce. #237 item 2 made the
...
def _config(rho, mu, velocity_m_s, max_iter, cauchy_eps):
    ...
    return f"""% Plane-Poiseuille validation case — written by AnkusDrive (issue #237).
