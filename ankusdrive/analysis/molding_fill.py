...
#
# The mechanics mirror the tutorial's AllRun (translated to SERIAL — ankusdrive runs no
...
def pack_phase_plan(fill_end_time_s: float, *, n_phases: int = 2,
    ...
    For the ankusdrive TOY/gate we keep it short: ``cool_window_s`` (default a few× the
