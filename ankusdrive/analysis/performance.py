...
AnkusDrive's contract layer was purely geometric: watertight, airtight path, envelope,
...
def validate_requirement(req: dict) -> dict:
    ...
    if not req.get("tool"):
        raise ValueError(f"requirement {name!r} needs a 'tool' — the AnkusDrive tool that "
