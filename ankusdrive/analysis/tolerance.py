...
Pure-Python, FreeCAD-free. The first family in AnkusDrive's simulation roadmap
(``docs/SIMULATION_TOOLS.md`` family 1 / Appendix A); it stands up the
``ankusdrive/analysis/`` pattern every other pure-Python family reuses. No geometry
