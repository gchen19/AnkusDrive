...
FreeCAD-free on purpose, exactly like :mod:`ankusdrive.drawing_gate`: everything here
...
FAI_DISCLAIMER = (
    "AS9102-SHAPED first-article characteristic list generated by AnkusDrive. "
...
# AS9102 Rev B Form 3 fields 5-12, verbatim, followed by the AnkusDrive columns that
...
FAI_COLUMNS = [
    ...
    "Notes",                          # 12
    "Lower Limit",                    # AnkusDrive
    "Upper Limit",                    # AnkusDrive
    "Measurement Method",             # AnkusDrive
    "Status",                         # AnkusDrive
]
